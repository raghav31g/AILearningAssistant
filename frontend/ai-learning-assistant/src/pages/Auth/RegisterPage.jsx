          ...
          <div className="absolute inset-0 bg-{radial-gradient(#e5e7eb_1px,transparent_1px),bg-size-[16px_16px] opacity-30}" />
              ...
              <div className="bg-white/60 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10 ">
                ...
                <div className="text-center mb-10">
                  ...
                  <p className="text-slate-500 text-sm">
                    Start your AI-powerd learning journey
                  </p>
                </div>
            ...
            {/* Password Field */}
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-white/0 to-white/0 translate-x-[-100%] group-hover:translate-x-[-100%] transition-transform duration-700" />
              </button>
            </div>
